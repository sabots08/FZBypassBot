...
async def start_msg(client, message):
    await message.reply(
        f"""<b><i>SA Bypass Bot!</i></b>
    
    <i>A Powerful Elegant Multi Threaded Bot written in Python... which can Bypass Various Shortener Links, Scrape links, and More ... </i>
    
    <i><b>Bot Started {convert_time(time() - BOT_START)} ago...</b></i>

🛃 <b>Join Here :</b> @sc_requests <i>(Bypass Topic)</i>""",
        quote=True,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🎓 Dev", url="https://t.me/amudhan_38"),
                    InlineKeyboardButton(
                        "🔍 Deploy Own",
                        url="https://github.com/sabots08/FZBypassBot",
                    ),
                ]
            ]
        ),
...
🎛 <b>Inline Use :</b> !bp [Single Link]""",
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Request movies Channel", url="https://t.me/sc_requests"
                            ),
                            InlineKeyboardButton(
